...
// 			Add(new ItemKey(2, 0, 504, 116), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 1, 1208, 116), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 1, 1320, 116), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 1, 280, 116), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 1, 392, 116), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 1, 616, 116), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 1, 984, 116), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 10, 2536, 116), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 10, 664, 116), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 12, 168, 256), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 12, 632, 256), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 16, 200, 192), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 17, 168, 192), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 17, 648, 192), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 19, 1048, 192), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 19, 168, 192), "Lantern TBD", null, LanternCube & LanternCube);
...
// 			Add(new ItemKey(2, 24, 1048, 192), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 24, 88, 192), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 31, 208, 96), "Lantern TBD", null, LanternCube & LanternCube);
...
// 			Add(new ItemKey(2, 36, 312, 208), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 37, 152, 192), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 37, 728, 192), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 39, 264, 192), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 39, 552, 192), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 4, 112, 512), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 4, 112, 96), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 4, 288, 512), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 4, 288, 96), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 41, 176, 208), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 41, 624, 208), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 42, 112, 512), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 42, 112, 96), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 42, 288, 512), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 42, 288, 96), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 43, 200, 192), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 43, 600, 192), "Lantern TBD", null, LanternCube & LanternCube);
...
// 			Add(new ItemKey(2, 5, 120, 100), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 5, 280, 100), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 51, 128, 96), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 51, 240, 96), "Lantern TBD", null, LanternCube & LanternCube);
...
// 			Add(new ItemKey(2, 57, 200, 100), "Lantern TBD", null, LanternCube & LanternCube);
...
// 			Add(new ItemKey(2, 59, 112, 96), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 59, 288, 96), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 60, 184, 100), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 9, 200, 192), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(2, 9, 600, 192), "Lantern TBD", null, LanternCube & LanternCube);
			areaName = "Library Top";
			areaName = "Varndagroth Tower Left";
			areaName = "Varndagroth Tower Right";
...
// 			Add(new ItemKey(11, 0, 264, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 16, 504, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 16, 696, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 17, 216, 281), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 18, 126, 144), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 18, 782, 112), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 19, 120, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 19, 264, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 22, 104, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 22, 104, 505), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 22, 280, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 22, 280, 505), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 23, 104, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 23, 280, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 3, 1448, 489), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 3, 152, 489), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 30, 152, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 34, 136, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 34, 264, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 35, 120, 1209), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 35, 120, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 35, 120, 537), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 35, 120, 905), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 35, 264, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 35, 280, 1209), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 35, 280, 537), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 35, 280, 905), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 36, 126, 176), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 36, 190, 176), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 36, 254, 176), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 37, 136, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 37, 264, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 4, 136, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 4, 264, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 6, 136, 169), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(11, 6, 264, 169), "Lantern TBD", null, LanternCube & LanternCube);

			areaName = "Emperor's Tower";
// 			Add(new ItemKey(12, 1, 122, 572), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 1, 218, 172), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 1, 234, 572), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 12, 1034, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 12, 1466, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 12, 170, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 12, 602, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 16, 122, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 16, 266, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 17, 106, 172), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 17, 282, 172), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 19, 106, 156), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 19, 282, 156), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 21, 122, 892), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 21, 298, 892), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 22, 106, 156), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 22, 282, 156), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 24, 122, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 24, 266, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 25, 122, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 26, 106, 156), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 26, 282, 156), "Lantern TBD", null, LanternCube & LanternCube);
			// TODO left lantern missing
// 			Add(new ItemKey(12, 3, 282, 124), "Lantern TBD", null, LanternCube & LanternCube);
			// TODO left bottom lantern missing
// 			Add(new ItemKey(12, 4, 106, 172), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 4, 282, 172), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 4, 282, 572), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 5, 122, 156), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 5, 298, 156), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 6, 1178, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 6, 1466, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 6, 314, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 6, 602, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 6, 890, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 7, 202, 1244), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 7, 202, 332), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 9, 122, 892), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(12, 9, 298, 892), "Lantern TBD", null, LanternCube & LanternCube);


			areaName = "Upper Lake Serene";
// 			Add(new ItemKey(7, 1, 2568, 107), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(7, 11, 184, 160), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(7, 11, 248, 160), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(7, 11, 312, 160), "Lantern TBD", null, LanternCube & LanternCube);
...
// 			Add(new ItemKey(7, 6, 1336, 256), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(7, 6, 472, 432), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(7, 6, 568, 192), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(7, 7, 1112, 592), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(7, 7, 1544, 592), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(7, 7, 1704, 155), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(7, 7, 488, 576), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(7, 7, 824, 608), "Lantern TBD", null, LanternCube & LanternCube);
			areaName = "Lower Lake Serene";

			areaName = "Caves of Banishment (Maw)";
// 			Add(new ItemKey(8, 0, 1032, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 0, 1176, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 0, 1416, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 0, 1576, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 0, 424, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 0, 568, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 1, 297, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 10, 120, 124), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 10, 184, 828), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 10, 232, 828), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 10, 296, 124), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 11, 153, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 11, 409, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 11, 793, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 11, 985, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 14, 1050, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 14, 1258, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 14, 1466, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 14, 218, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 14, 426, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 14, 634, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 16, 104, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 16, 104, 1756), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 16, 1096, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 16, 1096, 1756), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 16, 1096, 780), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 16, 920, 780), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 19, 520, 876), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 19, 536, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 19, 696, 876), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 19, 712, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 20, 1001, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 20, 297, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 20, 617, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 31, 105, 540), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 31, 265, 572), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 31, 281, 1516), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 31, 329, 124), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 31, 73, 124), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 37, 1032, 124), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 37, 1176, 124), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 37, 424, 124), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 37, 584, 124), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 38, 120, 124), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 38, 120, 508), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 38, 168, 828), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 38, 248, 828), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 38, 296, 124), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 43, 1050, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 43, 1258, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 43, 1466, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 43, 218, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 43, 426, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 46, 104, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 46, 296, 140), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 47, 122, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 47, 266, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 5, 121, 156), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 5, 1241, 156), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 5, 377, 156), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 5, 985, 156), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 8, 282, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 8, 392, 348), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 8, 392, 540), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 8, 506, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 9, 104, 124), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 9, 104, 508), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 9, 280, 124), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(8, 9, 280, 508), "Lantern TBD", null, LanternCube & LanternCube);
...
// 			Add(new ItemKey(5, 0, 184, 173), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 0, 456, 173), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 0, 744, 173), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 1, 200, 188), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 1, 200, 444), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 1, 200, 700), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 11, 122, 161), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 11, 298, 161), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 13, 200, 188), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 13, 200, 444), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 16, 298, 129), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 16, 490, 129), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 18, 200, 172), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 18, 200, 492), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 18, 200, 748), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 19, 168, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 19, 424, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 19, 728, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 19, 984, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 21, 184, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 21, 440, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 21, 728, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 21, 984, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 22, 152, 141), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 22, 264, 141), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 29, 200, 204), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 29, 200, 460), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 3, 1000, 445), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 3, 1016, 205), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 3, 184, 205), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 3, 200, 445), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 3, 552, 285), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 3, 648, 285), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 32, 488, 141), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 33, 122, 161), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 33, 298, 161), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 35, 298, 129), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 35, 490, 129), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 39, 200, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 39, 312, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 39, 488, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 39, 600, 157), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 4, 168, 173), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 4, 232, 173), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 41, 152, 173), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 41, 232, 173), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 43, 200, 172), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 43, 200, 428), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 44, 122, 161), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 44, 298, 161), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 6, 264, 141), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 6, 552, 141), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 6, 808, 141), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 7, 200, 188), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(5, 7, 200, 444), "Lantern TBD", null, LanternCube & LanternCube);
...
// 			Add(new ItemKey(6, 9, 199, 841), "Lantern TBD", null, LanternCube & LanternCube);
			...
			areaName = "Ancient Pyramid";
// 			Add(new ItemKey(16, 0, 152, 128), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 0, 247, 128), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 1, 202, 1526), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 1, 2202, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 10, 202, 1526), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 10, 2202, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 10, 634, 1494), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 11, 202, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 11, 2202, 1526), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 14, 202, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 15, 154, 886), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 15, 250, 886), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 16, 1002, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 16, 1402, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 16, 202, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 16, 602, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 17, 154, 566), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 17, 250, 566), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 18, 1002, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 18, 1402, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 18, 202, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 18, 602, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 2, 1370, 822), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 2, 202, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 2, 2202, 1526), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 20, 154, 886), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 20, 250, 866), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 22, 138, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 22, 266, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 23, 154, 566), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 23, 250, 566), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 24, 154, 566), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 24, 250, 566), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 25, 202, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 3, 152, 128), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 3, 247, 128), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 5, 152, 128), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 5, 247, 128), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 6, 154, 2486), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 6, 250, 2486), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 7, 202, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 7, 602, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 8, 202, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 9, 202, 166), "Lantern TBD", null, LanternCube & LanternCube);
// 			Add(new ItemKey(16, 9, 602, 166), "Lantern TBD", null, LanternCube & LanternCube);
