...
namespace TsRandomizer.Randomisation
{
	class ItemLocationMap : LookupDictionairy<ItemKey, ItemLocation>
	{
		...
		void AddPyramidItemLocations()
		{
			...
			Add(new ItemKey(16, 22, 200, 192), "", ItemInfo.Get(EItemType.MaxAura), Nightmare); //only requires LeftPyramid to rach but Nightmate to escape
			Add(new ItemKey(16, 16, 1512, 144), "", ItemInfo.Get(EInventoryRelicType.EssenceOfSpace), Nightmare); //only requires LeftPyramid to rach but Nightmate to escape
