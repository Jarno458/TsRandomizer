...
namespace TsRandomizer.Randomisation
{
	class ItemLocationMap : LookupDictionairy<ItemKey, ItemLocation>
	{
		...
		void AddPresentItemLocations()
		{
			...
			Add(new RoomItemKey(2, 52), "Varndagroth Spider hell", ItemProvider.Get(EInventoryRelicType.TimespinnerGear2), RightSideLibraryElevator & R.CardA);
		...
		void AddPastItemLocations()
		{
			...
			Add(new ItemKey(8, 3, 1256, 544), "Underwater banishment sirens right ground", ItemProvider.Get(EInventoryUseItemType.SilverOre), UpperCavesOfBanishment & R.Swimming);
			...
			Add(new ItemKey(6, 14, 184, 205), "Aelan's chest", ItemProvider.Get(EInventoryUseItemType.WarpCard), UpperRoyalTower);
		}
