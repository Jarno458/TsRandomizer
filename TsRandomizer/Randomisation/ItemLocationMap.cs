...
namespace TsRandomizer.Randomisation
{
	class ItemLocationMap : LookupDictionary<ItemKey, ItemLocation>
	{
		...
		void SetupGates()
		{
			...
			// TODO move to seperate flag
			LanternCube = (SeedOptions.PureTorcher)
				? R.LanternCube
				: R.Free;
...
// 			Add(new ItemKey(1, 16, 106, 461), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(1, 16, 282, 269), "Lantern TBD", null, LanternCube);
			Add(new ItemKey(1, 17, 282, 141), "Lake Desolation (Upper): Oxygen recovery room Lantern", null, UpperLakeDesolation);
// 			Add(new ItemKey(1, 19, 218, 365), "Lantern TBD", null, LanternCube);
			Add(new ItemKey(1, 20, 250, 237), "Lake Desolation (Upper): Double jump cave lantern", null, UpperLakeDesolation);
// 			Add(new ItemKey(1, 6, 474, 413), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(1, 6, 570, 173), "Lantern TBD", null, LanternCube);
			...
			areaName = "Library";
// 			Add(new ItemKey(2, 0, 1432, 116), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 0, 504, 116), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 1, 1208, 116), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 1, 1320, 116), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 1, 280, 116), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 1, 392, 116), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 1, 616, 116), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 1, 984, 116), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 10, 2536, 116), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 10, 664, 116), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 12, 168, 256), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 12, 632, 256), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 16, 200, 192), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 17, 168, 192), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 17, 648, 192), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 19, 1048, 192), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 19, 168, 192), "Lantern TBD", null, LanternCube);
			Add(new ItemKey(2, 20, 168, 1200), "Varndagroth Towers (Right): Right Elevator Lantern 1", null, RightSideLibraryElevator);
			Add(new ItemKey(2, 20, 168, 1840), "Varndagroth Towers (Right): Right Elevator Lantern 2", null, RightSideLibraryElevator);
			Add(new ItemKey(2, 20, 168, 208), "Varndagroth Towers (Right): Right Elevator Lantern 3", null, RightSideLibraryElevator);
			Add(new ItemKey(2, 20, 168, 2160), "Varndagroth Towers (Right): Right Elevator Lantern 4", null, RightSideLibraryElevator);
			Add(new ItemKey(2, 20, 168, 2512), "Varndagroth Towers (Right): Right Elevator Lantern 5", null, RightSideLibraryElevator);
			Add(new ItemKey(2, 20, 168, 880), "Varndagroth Towers (Right): Right Elevator Lantern 6", null, RightSideLibraryElevator);
			Add(new ItemKey(2, 23, 200, 560), "Varndagroth Towers (Right): Vent Lantern 1", null, UpperRightSideLibrary & (R.CardE | R.DoubleJump)); //needs only UpperRightSideLibrary but requires Elevator Card | Double Jump to get out
			Add(new ItemKey(2, 23, 648, 560), "Varndagroth Towers (Right): Vent Lantern 2", null, UpperRightSideLibrary & (R.CardE | R.DoubleJump)); //needs only UpperRightSideLibrary but requires Elevator Card | Double Jump to get out
			Add(new ItemKey(2, 23, 984, 560), "Varndagroth Towers (Right): Vent Lantern 3", null, UpperRightSideLibrary & (R.CardE | R.DoubleJump)); //needs only UpperRightSideLibrary but requires Elevator Card | Double Jump to get out
// 			Add(new ItemKey(2, 24, 1048, 192), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 24, 88, 192), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 31, 208, 96), "Lantern TBD", null, LanternCube);
			Add(new ItemKey(2, 32, 120, 192), "Varndagroth Towers (Left): Bottom floor Lantern", null, MidLibrary & R.CardC);
			Add(new ItemKey(2, 34, 232, 1520), "Varndagroth Towers (Left): Left Elevator Lantern 1", null, MidLibrary);
			Add(new ItemKey(2, 34, 232, 2512), "Varndagroth Towers (Left): Left Elevator Lantern 2", null, MidLibrary);
// 			Add(new ItemKey(2, 36, 312, 208), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 37, 152, 192), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 37, 728, 192), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 39, 264, 192), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 39, 552, 192), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 4, 112, 512), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 4, 112, 96), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 4, 288, 512), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 4, 288, 96), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 41, 176, 208), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 41, 624, 208), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 42, 112, 512), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 42, 112, 96), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 42, 288, 512), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 42, 288, 96), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 43, 200, 192), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 43, 600, 192), "Lantern TBD", null, LanternCube);
			Add(new ItemKey(2, 44, 1072, 496), "Library: Lantern 1", null, LeftLibrary);
			Add(new ItemKey(2, 44, 112, 496), "Library: Lantern 2", null, LeftLibrary);
			Add(new ItemKey(2, 44, 400, 496), "Library: Lantern 3", null, LeftLibrary);
			Add(new ItemKey(2, 44, 400, 96), "Library: Lantern 4", null, LeftLibrary);
			Add(new ItemKey(2, 44, 624, 496), "Library: Lantern 5", null, LeftLibrary);
			Add(new ItemKey(2, 44, 736, 96), "Library: Lantern 6", null, LeftLibrary);
			Add(new ItemKey(2, 44, 848, 496), "Library: Lantern 7", null, LeftLibrary);
			Add(new ItemKey(2, 47, 128, 96), "Library: Storage room Lantern 1", null, LeftLibrary & R.CardD);
			Add(new ItemKey(2, 47, 240, 96), "Library: Storage room Lantern 2", null, LeftLibrary & R.CardD);
// 			Add(new ItemKey(2, 5, 120, 100), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 5, 280, 100), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 51, 128, 96), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 51, 240, 96), "Lantern TBD", null, LanternCube);
			Add(new ItemKey(2, 56, 1072, 96), "Library: Backer room Lantern 1", null, UpperLeftLibrary);
			Add(new ItemKey(2, 56, 176, 96), "Library: Backer room Lantern 2", null, UpperLeftLibrary);
			Add(new ItemKey(2, 56, 400, 96), "Library: Backer room Lantern 3", null, UpperLeftLibrary);
			Add(new ItemKey(2, 56, 624, 96), "Library: Backer room Lantern 4", null, UpperLeftLibrary);
			Add(new ItemKey(2, 56, 848, 96), "Library: Backer room Lantern 5", null, UpperLeftLibrary);
// 			Add(new ItemKey(2, 57, 200, 100), "Lantern TBD", null, LanternCube);
			Add(new ItemKey(2, 58, 160, 96), "Library: V Room Lantern 1", null, LeftLibrary);
			Add(new ItemKey(2, 58, 272, 96), "Library: V Room Lantern 2", null, LeftLibrary);
// 			Add(new ItemKey(2, 59, 112, 96), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 59, 288, 96), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 60, 184, 100), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 9, 200, 192), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(2, 9, 600, 192), "Lantern TBD", null, LanternCube);
			areaName = "Library Top";
			areaName = "Varndagroth Tower Left";
			areaName = "Varndagroth Tower Right";

			areaName = "Sealed Caves (Xarion)";
			Add(new ItemKey(9, 0, 1032, 140), "Sealed Caves (Xarion) First Hall Lantern 1", null, SealedCaves);
			Add(new ItemKey(9, 0, 1176, 140), "Sealed Caves (Xarion) First Hall Lantern 2", null, SealedCaves);
			Add(new ItemKey(9, 0, 1416, 140), "Sealed Caves (Xarion) First Hall Lantern 3", null, SealedCaves);
			Add(new ItemKey(9, 0, 1576, 140), "Sealed Caves (Xarion) First Hall Lantern 4", null, SealedCaves);
			Add(new ItemKey(9, 0, 424, 140), "Sealed Caves (Xarion) First Hall Lantern 5", null, SealedCaves);
			Add(new ItemKey(9, 0, 568, 140), "Sealed Caves (Xarion) First Hall Lantern 6", null, SealedCaves);
			Add(new ItemKey(9, 37, 1032, 124), "Sealed Caves (Xarion) Second Hall Lantern 1", null, SealedCaves);
			Add(new ItemKey(9, 37, 1176, 124), "Sealed Caves (Xarion) Second Hall Lantern 2", null, SealedCaves);
			Add(new ItemKey(9, 37, 424, 124), "Sealed Caves (Xarion) Second Hall Lantern 3", null, SealedCaves);
			Add(new ItemKey(9, 37, 584, 124), "Sealed Caves (Xarion) Second Hall Lantern 4", null, SealedCaves);
			Add(new ItemKey(9, 38, 120, 124), "Sealed Caves (Xarion) Forked Shaft Lantern 1", null, SealedCaves);
			Add(new ItemKey(9, 38, 120, 508), "Sealed Caves (Xarion) Forked Shaft Lantern 2", null, SealedCaves);
			Add(new ItemKey(9, 38, 168, 828), "Sealed Caves (Xarion) Forked Shaft Lantern 3", null, SealedCaves);
			Add(new ItemKey(9, 38, 248, 828), "Sealed Caves (Xarion) Forked Shaft Lantern 4", null, SealedCaves);
			Add(new ItemKey(9, 38, 296, 124), "Sealed Caves (Xarion) Forked Shaft Lantern 5", null, SealedCaves);
			Add(new ItemKey(9, 19, 1096, 1756), "Sealed Caves (Xarion): Shroom jump Lantern 1", ItemProvider.Get(EInventoryUseItemType.Antidote), SealedCaves & R.TimeStop);
			Add(new ItemKey(9, 19, 520, 876), "Sealed Caves (Xarion): Shroom jump Lantern 2", ItemProvider.Get(EInventoryUseItemType.Antidote), SealedCaves & R.TimeStop);
			Add(new ItemKey(9, 19, 536, 140), "Sealed Caves (Xarion): Shroom jump Lantern 3", ItemProvider.Get(EInventoryUseItemType.Antidote), SealedCaves & R.TimeStop);
			Add(new ItemKey(9, 19, 696, 876), "Sealed Caves (Xarion): Shroom jump Lantern 4", ItemProvider.Get(EInventoryUseItemType.Antidote), SealedCaves & R.TimeStop);
			Add(new ItemKey(9, 46, 104, 140), "Sealed Caves (Xarion): Lower Fork Start Lantern 1", null, SealedCaves);
			Add(new ItemKey(9, 46, 296, 140), "Sealed Caves (Xarion): Lower Fork Start Lantern 2", null, SealedCaves);
			Add(new ItemKey(9, 9, 104, 124), "Sealed Caves (Xarion): Lower Fork Vertical Room Lantern 1", null, SealedCaves);
			Add(new ItemKey(9, 9, 104, 508), "Sealed Caves (Xarion): Lower Fork Vertical Room Lantern 2", null, SealedCaves);
			Add(new ItemKey(9, 9, 280, 124), "Sealed Caves (Xarion): Lower Fork Vertical Room Lantern 3", null, SealedCaves);
			Add(new ItemKey(9, 9, 280, 508), "Sealed Caves (Xarion): Lower Fork Vertical Room Lantern 4", null, SealedCaves);
			Add(new ItemKey(9, 10, 120, 124), "Sealed Caves (Xarion): Skeleton Lantern 1", null, SealedCavesSkeleton);
			Add(new ItemKey(9, 10, 184, 828), "Sealed Caves (Xarion): Skeleton Lantern 2", null, SealedCavesSkeleton);
			Add(new ItemKey(9, 10, 296, 124), "Sealed Caves (Xarion): Skeleton Lantern 3", null, SealedCavesSkeleton);
			Add(new ItemKey(9, 16, 1096, 140), "Sealed Caves (Xarion): Mini jackpot ledge Lantern", null, SealedCaves & ForwardDashDoubleJump);
			Add(new ItemKey(9, 16, 104, 140), "Sealed Caves (Xarion): Pre-Jackpot Waterfall Room Lantern 1", null, SealedCaves);
			Add(new ItemKey(9, 16, 104, 1756), "Sealed Caves (Xarion): Pre-Jackpot Waterfall Room Lantern 2", null, SealedCaves);
			Add(new ItemKey(9, 16, 1096, 1756), "Sealed Caves (Xarion): Pre-Jackpot Waterfall Room Lantern 3", null, SealedCaves);
			Add(new ItemKey(9, 16, 1096, 780), "Sealed Caves (Xarion): Pre-Jackpot Waterfall Room Lantern 4", null, SealedCaves);
			Add(new ItemKey(9, 16, 920, 780), "Sealed Caves (Xarion): Pre-Jackpot Waterfall Room Lantern 5", null, SealedCaves);
			Add(new ItemKey(9, 47, 122, 157), "Sealed Caves (Xarion): Post-Fork Room Lantern 1", null, SealedCaves);
			Add(new ItemKey(9, 47, 266, 157), "Sealed Caves (Xarion): Post-Fork Room Lantern 2", null, SealedCaves);
			Add(new ItemKey(9, 43, 1050, 157), "Sealed Caves (Xarion): Rejoined Hallway Lantern 1", null, SealedCaves);
			Add(new ItemKey(9, 43, 1258, 157), "Sealed Caves (Xarion): Rejoined Hallway Lantern 2", null, SealedCaves);
			Add(new ItemKey(9, 43, 1466, 157), "Sealed Caves (Xarion): Rejoined Hallway Lantern 3", null, SealedCaves);
			Add(new ItemKey(9, 43, 218, 157), "Sealed Caves (Xarion): Rejoined Hallway Lantern 4", null, SealedCaves);
			Add(new ItemKey(9, 43, 426, 157), "Sealed Caves (Xarion): Rejoined Hallway Lantern 5", null, SealedCaves);
			Add(new ItemKey(9, 43, 634, 157), "Sealed Caves (Xarion): Rejoined Hallway Lantern 6", null, SealedCaves);
			Add(new ItemKey(9, 14, 1050, 157), "Sealed Caves (Xarion): Penultimate Hall Lantern 1", null, SealedCaves);
			Add(new ItemKey(9, 14, 1258, 157), "Sealed Caves (Xarion): Penultimate Hall Lantern 2", null, SealedCaves);
			Add(new ItemKey(9, 14, 1466, 157), "Sealed Caves (Xarion): Penultimate Hall Lantern 3", null, SealedCaves);
			Add(new ItemKey(9, 14, 218, 157), "Sealed Caves (Xarion): Penultimate Hall Lantern 4", null, SealedCaves);
			Add(new ItemKey(9, 14, 426, 157), "Sealed Caves (Xarion): Penultimate Hall Lantern 5", null, SealedCaves);
			Add(new ItemKey(9, 14, 634, 157), "Sealed Caves (Xarion): Penultimate Hall Lantern 6", null, SealedCaves);
			Add(new ItemKey(9, 8, 282, 157), "Sealed Caves (Xarion): Last chance room Lantern 1", null, SealedCaves);
			Add(new ItemKey(9, 8, 392, 348), "Sealed Caves (Xarion): Last chance room Lantern 2", null, SealedCaves);
			Add(new ItemKey(9, 8, 392, 540), "Sealed Caves (Xarion): Last chance room Lantern 3", null, SealedCaves);
			Add(new ItemKey(9, 8, 506, 157), "Sealed Caves (Xarion): Last chance room Lantern 4", null, SealedCaves & R.DoubleJump);

			areaName = "Sealed Caves (Sirens)";
			Add(new ItemKey(9, 11, 153, 140), "Sealed Caves (Sirens): Middle Hall Lantern 1", null, SealedCavesSirens);
			Add(new ItemKey(9, 11, 409, 140), "Sealed Caves (Sirens): Middle Hall Lantern 2", null, SealedCavesSirens);
			Add(new ItemKey(9, 11, 793, 140), "Sealed Caves (Sirens): Middle Hall Lantern 3", null, SealedCavesSirens);
			Add(new ItemKey(9, 11, 985, 140), "Sealed Caves (Sirens): Middle Hall Lantern 4", null, SealedCavesSirens);
			Add(new ItemKey(9, 20, 1001, 140), "Sealed Caves (Sirens): First Hall Lantern 1", null, SealedCavesSirens);
			Add(new ItemKey(9, 20, 297, 140), "Sealed Caves (Sirens): First Hall Lantern 2", null, SealedCavesSirens);
			Add(new ItemKey(9, 20, 617, 140), "Sealed Caves (Sirens): First Hall Lantern 3", null, SealedCavesSirens);
			Add(new ItemKey(9, 31, 329, 124), "Sealed Caves (Sirens): Condemned Shaft Lantern 1", null, SealedCavesSirens);
			Add(new ItemKey(9, 31, 73, 124), "Sealed Caves (Sirens): Condemned Shaft Lantern 2", null, SealedCavesSirens);

			areaName = "Military Fortress";
// 			Add(new ItemKey(10, 1, 136, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 1, 264, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 18, 120, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 3, 232, 508), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 3, 232, 876), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 3, 568, 508), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 3, 568, 876), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 4, 1512, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 4, 264, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 4, 744, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 5, 120, 556), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 5, 280, 556), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 6, 1048, 556), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 6, 152, 556), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 8, 1512, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 8, 248, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(10, 8, 632, 140), "Lantern TBD", null, LanternCube);

			areaName = "The Lab";
// 			Add(new ItemKey(11, 0, 136, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 0, 264, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 16, 504, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 16, 696, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 17, 216, 281), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 18, 126, 144), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 18, 782, 112), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 19, 120, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 19, 264, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 22, 104, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 22, 104, 505), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 22, 280, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 22, 280, 505), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 23, 104, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 23, 280, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 3, 1448, 489), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 3, 152, 489), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 30, 152, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 34, 136, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 34, 264, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 35, 120, 1209), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 35, 120, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 35, 120, 537), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 35, 120, 905), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 35, 264, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 35, 280, 1209), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 35, 280, 537), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 35, 280, 905), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 36, 126, 176), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 36, 190, 176), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 36, 254, 176), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 37, 136, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 37, 264, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 4, 136, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 4, 264, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 6, 136, 169), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(11, 6, 264, 169), "Lantern TBD", null, LanternCube);

			areaName = "Emperor's Tower";
// 			Add(new ItemKey(12, 1, 122, 572), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 1, 218, 172), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 1, 234, 572), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 12, 1034, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 12, 1466, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 12, 170, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 12, 602, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 16, 122, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 16, 266, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 17, 106, 172), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 17, 282, 172), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 19, 106, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 19, 282, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 21, 122, 892), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 21, 298, 892), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 22, 106, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 22, 282, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 24, 122, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 24, 266, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 25, 122, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 26, 106, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 26, 282, 156), "Lantern TBD", null, LanternCube);
			// TODO left lantern missing
// 			Add(new ItemKey(12, 3, 282, 124), "Lantern TBD", null, LanternCube);
			// TODO left bottom lantern missing
// 			Add(new ItemKey(12, 4, 106, 172), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 4, 282, 172), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 4, 282, 572), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 5, 122, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 5, 298, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 6, 1178, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 6, 1466, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 6, 314, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 6, 602, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 6, 890, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 7, 202, 1244), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 7, 202, 332), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 9, 122, 892), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(12, 9, 298, 892), "Lantern TBD", null, LanternCube);


			areaName = "Upper Lake Serene";
// 			Add(new ItemKey(7, 1, 2568, 107), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 11, 184, 160), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 11, 248, 160), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 11, 312, 160), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 14, 104, 283), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 15, 200, 187), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 15, 2104, 187), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 15, 2200, 187), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 15, 296, 187), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 17, 312, 267), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 2, 1480, 688), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 2, 152, 688), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 2, 936, 656), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 20, 184, 240), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 3, 120, 379), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 3, 328, 736), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 3, 392, 1104), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 4, 328, 155), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 6, 1336, 256), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 6, 472, 432), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 6, 568, 192), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 7, 1112, 592), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 7, 1544, 592), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 7, 1704, 155), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 7, 488, 576), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(7, 7, 824, 608), "Lantern TBD", null, LanternCube);
			areaName = "Lower Lake Serene";

			areaName = "Caves of Banishment (Maw)";
// 			Add(new ItemKey(8, 0, 1032, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 0, 1176, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 0, 1416, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 0, 1576, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 0, 424, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 0, 568, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 1, 297, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 10, 120, 124), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 10, 184, 828), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 10, 232, 828), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 10, 296, 124), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 11, 153, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 11, 409, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 11, 793, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 11, 985, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 14, 1050, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 14, 1258, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 14, 1466, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 14, 218, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 14, 426, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 14, 634, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 16, 104, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 16, 104, 1756), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 16, 1096, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 16, 1096, 1756), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 16, 1096, 780), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 16, 920, 780), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 19, 520, 876), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 19, 536, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 19, 696, 876), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 19, 712, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 20, 1001, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 20, 297, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 20, 617, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 31, 105, 540), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 31, 265, 572), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 31, 281, 1516), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 31, 329, 124), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 31, 73, 124), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 37, 1032, 124), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 37, 1176, 124), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 37, 424, 124), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 37, 584, 124), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 38, 120, 124), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 38, 120, 508), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 38, 168, 828), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 38, 248, 828), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 38, 296, 124), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 43, 1050, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 43, 1258, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 43, 1466, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 43, 218, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 43, 426, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 46, 104, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 46, 296, 140), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 47, 122, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 47, 266, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 5, 121, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 5, 1241, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 5, 377, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 5, 985, 156), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 8, 282, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 8, 392, 348), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 8, 392, 540), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 8, 506, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 9, 104, 124), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 9, 104, 508), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 9, 280, 124), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(8, 9, 280, 508), "Lantern TBD", null, LanternCube);

			areaName = "Caves of Banishment (Sirens)";
			areaName = "Refugee Camp";
			areaName = "Forest";
// 			Add(new ItemKey(3, 1, 235, 125), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(3, 12, 1019, 109), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(3, 13, 1227, 125), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(3, 13, 251, 125), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(3, 13, 747, 125), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(3, 2, 235, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(3, 4, 1691, 77), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(3, 4, 411, 77), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(3, 7, 1307, 125), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(3, 8, 235, 125), "Lantern TBD", null, LanternCube);

			areaName = "Castle Ramparts";
// 			Add(new ItemKey(4, 10, 122, 161), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 10, 266, 161), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 11, 138, 161), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 11, 282, 161), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 21, 106, 161), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 21, 298, 161), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 22, 298, 161), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 3, 234, 561), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 3, 570, 561), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 4, 1418, 129), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 4, 378, 129), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 4, 922, 129), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 5, 202, 497), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 5, 312, 264), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 5, 88, 264), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 6, 234, 561), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 6, 280, 104), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 6, 520, 104), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 6, 570, 561), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 7, 202, 497), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 7, 312, 264), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 7, 88, 264), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 8, 1418, 129), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 8, 362, 129), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(4, 8, 858, 129), "Lantern TBD", null, LanternCube);

			areaName = "Castle Keep";
// 			Add(new ItemKey(5, 0, 1032, 173), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 0, 184, 173), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 0, 456, 173), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 0, 744, 173), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 1, 200, 188), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 1, 200, 444), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 1, 200, 700), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 11, 122, 161), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 11, 298, 161), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 13, 200, 188), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 13, 200, 444), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 16, 298, 129), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 16, 490, 129), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 18, 200, 172), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 18, 200, 492), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 18, 200, 748), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 19, 168, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 19, 424, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 19, 728, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 19, 984, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 21, 184, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 21, 440, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 21, 728, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 21, 984, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 22, 152, 141), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 22, 264, 141), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 29, 200, 204), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 29, 200, 460), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 3, 1000, 445), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 3, 1016, 205), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 3, 184, 205), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 3, 200, 445), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 3, 552, 285), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 3, 648, 285), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 32, 488, 141), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 33, 122, 161), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 33, 298, 161), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 35, 298, 129), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 35, 490, 129), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 39, 200, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 39, 312, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 39, 488, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 39, 600, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 4, 168, 173), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 4, 232, 173), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 41, 152, 173), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 41, 232, 173), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 43, 200, 172), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 43, 200, 428), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 44, 122, 161), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 44, 298, 161), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 6, 264, 141), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 6, 552, 141), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 6, 808, 141), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 7, 200, 188), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(5, 7, 200, 444), "Lantern TBD", null, LanternCube);

			areaName = "Royal Towers";
// 			Add(new ItemKey(6, 1, 1114, 257), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 1, 1402, 257), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 1, 250, 257), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 1, 538, 257), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 1, 826, 257), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 10, 138, 253), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 10, 266, 253), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 11, 298, 173), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 16, 202, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 16, 346, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 16, 58, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 2, 74, 349), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 2, 74, 541), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 21, 154, 893), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 21, 250, 893), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 22, 154, 173), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 22, 250, 173), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 24, 122, 141), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 24, 266, 141), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 25, 135, 73), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 25, 87, 73), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 27, 394, 157), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 27, 394, 541), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 3, 330, 173), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 7, 202, 1245), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 7, 202, 333), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 9, 199, 217), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 9, 199, 537), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(6, 9, 199, 841), "Lantern TBD", null, LanternCube);

			areaName = "Ancient Pyramid";
// 			Add(new ItemKey(16, 0, 152, 128), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 0, 247, 128), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 1, 202, 1526), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 1, 2202, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 10, 202, 1526), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 10, 2202, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 10, 634, 1494), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 11, 202, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 11, 2202, 1526), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 14, 202, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 15, 154, 886), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 15, 250, 886), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 16, 1002, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 16, 1402, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 16, 202, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 16, 602, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 17, 154, 566), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 17, 250, 566), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 18, 1002, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 18, 1402, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 18, 202, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 18, 602, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 2, 1370, 822), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 2, 202, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 2, 2202, 1526), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 20, 154, 886), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 20, 250, 866), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 22, 138, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 22, 266, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 23, 154, 566), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 23, 250, 566), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 24, 154, 566), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 24, 250, 566), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 25, 202, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 3, 152, 128), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 3, 247, 128), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 5, 152, 128), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 5, 247, 128), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 6, 154, 2486), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 6, 250, 2486), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 7, 202, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 7, 602, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 8, 202, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 9, 202, 166), "Lantern TBD", null, LanternCube);
// 			Add(new ItemKey(16, 9, 602, 166), "Lantern TBD", null, LanternCube);
