...
namespace TsRandomizer.Randomisation
{
	class ItemLocationMap : LookupDictionary<ItemKey, ItemLocation>
	{
		...
		void AddLanternLocations()
		{
			...
			areaName = "Sealed Caves (Xarion)";
			Add(new ItemKey(9, 0, 1032, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 0, 1176, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 0, 1416, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 0, 1576, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 0, 424, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 0, 568, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 10, 120, 124), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 10, 184, 828), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 10, 296, 124), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 11, 153, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 11, 409, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 11, 793, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 11, 985, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 14, 1050, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 14, 1258, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 14, 1466, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 14, 218, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 14, 426, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 14, 634, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 16, 104, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 16, 104, 1756), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 16, 1096, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 16, 1096, 1756), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 16, 1096, 780), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 16, 920, 780), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 19, 1096, 1756), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 19, 520, 876), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 19, 536, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 19, 696, 876), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 20, 1001, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 20, 297, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 20, 617, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 31, 329, 124), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 31, 73, 124), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 37, 1032, 124), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 37, 1176, 124), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 37, 424, 124), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 37, 584, 124), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 38, 120, 124), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 38, 120, 508), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 38, 168, 828), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 38, 248, 828), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 38, 296, 124), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 43, 1050, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 43, 1258, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 43, 1466, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 43, 218, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 43, 426, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 43, 634, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 46, 104, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 46, 296, 140), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 47, 122, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 47, 266, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 8, 282, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 8, 392, 348), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 8, 392, 540), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 8, 506, 157), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 9, 104, 124), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 9, 104, 508), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 9, 280, 124), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(9, 9, 280, 508), "Lantern TBD", null, RefugeeCamp);
