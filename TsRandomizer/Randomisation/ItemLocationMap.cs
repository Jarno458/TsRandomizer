...
namespace TsRandomizer.Randomisation
{
	class ItemLocationMap : LookupDictionary<ItemKey, ItemLocation>
	{
		...
		void AddLanternLocations()
		{
			...
			Add(new ItemKey(2, 20, 168, 1200), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 20, 168, 1840), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 20, 168, 208), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 20, 168, 2160), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 20, 168, 2512), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 20, 168, 880), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 23, 200, 560), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 23, 648, 560), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 23, 984, 560), "Lantern TBD", null, RefugeeCamp);
			...
			Add(new ItemKey(2, 32, 120, 192), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 34, 232, 1520), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 34, 232, 2512), "Lantern TBD", null, RefugeeCamp);
			...
			Add(new ItemKey(2, 44, 1072, 496), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 44, 112, 496), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 44, 400, 496), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 44, 400, 96), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 44, 624, 496), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 44, 736, 96), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 44, 848, 496), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 47, 128, 96), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 47, 240, 96), "Lantern TBD", null, RefugeeCamp);
			...
			Add(new ItemKey(2, 56, 1072, 96), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 56, 176, 96), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 56, 400, 96), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 56, 624, 96), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 56, 848, 96), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 57, 200, 100), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 58, 160, 96), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(2, 58, 272, 96), "Lantern TBD", null, RefugeeCamp);
			...
			// Debug zone
			/*
			Add(new ItemKey(0, 3, 344, 2969), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(0, 3, 616, 2969), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(0, 3, 88, 2969), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(0, 4, 312, 169), "Lantern TBD", null, RefugeeCamp);
			Add(new ItemKey(0, 4, 72, 169), "Lantern TBD", null, RefugeeCamp);
