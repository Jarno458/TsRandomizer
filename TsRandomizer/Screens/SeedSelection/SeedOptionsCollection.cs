...
namespace TsRandomizer.Screens.SeedSelection
{
	class SeedOptionsCollection : InventoryRelicCollection
	{
		static readonly Dictionary<int, SeedOptionInfo> Options = new Dictionary<int, SeedOptionInfo>
		{
			...
			{ 1 << 14, new SeedOptionInfo { Name = "Fast Pyramid", Description = "Ancient Pyramid is unlocked by the Twin Pyramid Keys. You still need to break time to open the final boss door." } },
			{ 1 << 15, new SeedOptionInfo { Name = "Enter Sandman", Description = "Fast Pyramid, but the final boss door opens if you have all 5 Timespinner pieces." } },
